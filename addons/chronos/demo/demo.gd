extends Control
## Demo UI for testing Chronos

@onready var sky: Chronos = $"../Chronos"
...
# Load presets once
var _clear: WeatherPreset = preload("res://addons/chronos/presets/clear.tres")
var _overcast: WeatherPreset = preload("res://addons/chronos/presets/overcast.tres")
var _foggy: WeatherPreset = preload("res://addons/chronos/presets/foggy.tres")
var _rainy: WeatherPreset = preload("res://addons/chronos/presets/rainy.tres")
